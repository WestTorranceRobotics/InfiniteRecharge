...
public class ZoomZoom extends RamseteCommand {
  ...
  public ZoomZoom(Trajectory path, DriveTrain drivebase) {
    super(
      ...
      new SimpleMotorFeedforward(DriveTrainMap.ksVolts, 
                                 DriveTrainMap.kaVoltSecondsSquaredPerInches,
                                 DriveTrainMap.kMaxAccelerationInchesPerSecondSquared),
      new DifferentialDriveKinematics(DriveTrainMap.kTrackwidthInches),
