...
public class Shooter extends PIDSubsystem {
    ...
    private int kShooterMotorPort = 1;
    private int kFeederMotorPort = 2;
    ...
    private double kShooterTargetRPS = 85.0;
    ...
    private DigitalInput photoelectricBallDetectorDigitalInput = new DigitalInput(6);;
